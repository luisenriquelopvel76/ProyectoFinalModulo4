...
public class Principal {
    public static void main(String[] args) {
        ...
        List<Integer> ids = List.of(100, 1004, 354, 478, 545, 64, 846, 154, 965, 100);
    ...
    private List<City> fetchData(Principal main) {
    ...
    private void testMysqlData(List<Integer> ids) {
        try (Session session = sessionFactory.getCurrentSession()) {
           ...
           // System.out.println("\nTest to MySQL\n");
            ...
            //    System.out.println("\nCiudad:\n" +  "nombre y lenguaje: " + city.getCountry().getName() + " " + city.getName());
            }
            session.getTransaction().commit();
        }
    }
